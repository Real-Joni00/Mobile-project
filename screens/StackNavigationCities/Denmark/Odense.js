...
const Odense = () => {
    ...
    const yearsstudiedOdense = () => {
        fetch("https://stat.hel.fi:443/api/v1/fi/Nordstat/6_Koulutustaso/6-1NS_Vaeston_koulutus.px", {
          ...
          .then((json) => setOdenseyearsstudied(json.dataset.value));
      }
            ...
            >
                <Header/>
                    <ScrollView style={styles.cityScrollview}>
                            <Text style={styles.cityText}>Odense</Text>
                                <Text style={styles.citypgSubheaders}>Residents with over 13 years of studies</Text>
                                <View style={styles.cityImageView}>
                                    <Image source={require('../Denmark/images/odenseyearsstudied.jpg')} 
                                    style={styles.cityImages}
                                />
                                </View>
                                <Text style={styles.cityTexts}>2018: <Text style={styles.cityData}>{odenseyearsstudied[0]}</Text>
                                    {"\n"}2019: <Text style={styles.cityData}>{odenseyearsstudied[1]}</Text>
