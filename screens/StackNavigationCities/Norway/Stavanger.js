...
const Stavanger = () => {
    ...
    const yearsstudiedStavanger = () => {
        fetch("https://stat.hel.fi:443/api/v1/fi/Nordstat/6_Koulutustaso/6-1NS_Vaeston_koulutus.px", {
          ...
          .then((json) => setStavangeryearsstudied(json.dataset.value));
      }
            ...
            >
                <Header/>
                    <ScrollView style={styles.cityScrollview}>
                            <Text style={styles.cityText}>Stavanger</Text>
                                <Text style={styles.citypgSubheaders}>Residents with over 13 years of studies</Text>
                                <View style={styles.cityImageView}>
                                    <Image source={require('../Norway/images/stavangeryearsstudied.jpg')} 
                                    style={styles.cityImages}
                                />
                                </View>
                                <Text style={styles.cityTexts}>2018: <Text style={styles.cityData}>{stavangeryearsstudied[0]}</Text>
                                    {"\n"}2019: <Text style={styles.cityData}>{stavangeryearsstudied[1]}</Text>
